...
/*2.	Usando la función anterior benefíciate de poder conocer el indice del array para crear una función llamada removeItem que, pasándole un array y un texto como parámetros (los mismos parámetros que en el anterior ejercicio), llame a la función anteriormente creadaz findArrayIndex y obtén el indice para posteriormente usar la función de javascript .splice() para eliminar el elemento del array.
...
function removeItem(array, indice2) {
    //Tu codigo
     array.splice(indice2, 1)
    
  return array
}
console.log(removeItem(mainCharacters,indice1))
